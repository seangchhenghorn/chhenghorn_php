...
femployeesadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($employees_add->salary->Required) { ?>
		...
		<?php } ?>
			...
			if (elm && !ew.checkInteger(elm.value))
				return this.onError(elm, "<?php echo JsEncode($employees->salary->errorMessage()) ?>");
...
<?php if ($employees->name->Visible) { // name ?>
	<div id="r_name" class="form-group row">
		<label id="elh_employees_name" for="x_name" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->name->caption() ?><?php echo ($employees->name->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->name->cellAttributes() ?>>
<span id="el_employees_name">
<input type="text" data-table="employees" data-field="x_name" name="x_name" id="x_name" size="30" maxlength="100" placeholder="<?php echo HtmlEncode($employees->name->getPlaceHolder()) ?>" value="<?php echo $employees->name->EditValue ?>"<?php echo $employees->name->editAttributes() ?>>
</span>
...
<?php if ($employees->address->Visible) { // address ?>
	<div id="r_address" class="form-group row">
		<label id="elh_employees_address" for="x_address" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->address->caption() ?><?php echo ($employees->address->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="text" data-table="employees" data-field="x_address" name="x_address" id="x_address" size="30" maxlength="255" placeholder="<?php echo HtmlEncode($employees->address->getPlaceHolder()) ?>" value="<?php echo $employees->address->EditValue ?>"<?php echo $employees->address->editAttributes() ?>>
</span>
...
<?php if ($employees->salary->Visible) { // salary ?>
	<div id="r_salary" class="form-group row">
		<label id="elh_employees_salary" for="x_salary" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->salary->caption() ?><?php echo ($employees->salary->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->salary->cellAttributes() ?>>
<span id="el_employees_salary">
<input type="text" data-table="employees" data-field="x_salary" name="x_salary" id="x_salary" size="30" placeholder="<?php echo HtmlEncode($employees->salary->getPlaceHolder()) ?>" value="<?php echo $employees->salary->EditValue ?>"<?php echo $employees->salary->editAttributes() ?>>
</span>
...
<?php if ($employees->photo->Visible) { // photo ?>
	<div id="r_photo" class="form-group row">
		<label id="elh_employees_photo" for="x_photo" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->photo->caption() ?><?php echo ($employees->photo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->photo->cellAttributes() ?>>
<span id="el_employees_photo">
<input type="text" data-table="employees" data-field="x_photo" name="x_photo" id="x_photo" size="30" maxlength="250" placeholder="<?php echo HtmlEncode($employees->photo->getPlaceHolder()) ?>" value="<?php echo $employees->photo->EditValue ?>"<?php echo $employees->photo->editAttributes() ?>>
</span>
