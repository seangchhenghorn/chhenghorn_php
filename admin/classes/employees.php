...
class employees extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('employees', 'employees', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// name
		$this->name = new DbField('employees', 'employees', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// salary
		$this->salary = new DbField('employees', 'employees', 'x_salary', 'salary', '`salary`', '`salary`', 3, -1, FALSE, '`salary`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->salary->Nullable = FALSE; // NOT NULL field
		$this->salary->Required = TRUE; // Required field
