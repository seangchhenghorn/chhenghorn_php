...
class users_add extends users
{
	...
	protected function validateForm()
	{
		...
		if ($this->full_name->Required) {
			if (!$this->full_name->IsDetailKey && $this->full_name->FormValue != NULL && $this->full_name->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->full_name->caption(), $this->full_name->RequiredErrorMessage));
			}
		}
		...
		if (!CheckInteger($this->group_id->FormValue)) {
			AddMessage($FormError, $this->group_id->errorMessage());
		}
