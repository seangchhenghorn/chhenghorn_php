...
// Page class
//
class countries_view extends countries
{
	...
	// Page object name
	public $PageObjName = "countries_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("countrieslist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "countrieslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "countrieslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "countrieslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
