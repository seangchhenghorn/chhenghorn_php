...
// Page class
//
class article_edit extends article
{
	...
	// Page object name
	public $PageObjName = "article_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if ($CurrentForm->hasValue("x_category_id")) {
				$this->category_id->setFormValue($CurrentForm->getValue("x_category_id"));
			}
		} else {
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			$this->photo->OldUploadPath = "../upload/article";
			...
			// created_date
			$this->created_date->setDbValueDef($rsnew, UnFormatDateTime($this->created_date->CurrentValue, 0), NULL, $this->created_date->ReadOnly);
