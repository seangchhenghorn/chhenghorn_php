...
// Page class
//
class article_delete extends article
{
	...
	// Page object name
	public $PageObjName = "article_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("articlelist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("articlelist.php"); // Return to list
			}
		}
	}
