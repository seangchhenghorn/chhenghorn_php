...
// Page class
//
class product_delete extends product
{
	...
	// Page object name
	public $PageObjName = "product_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("productlist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("productlist.php"); // Return to list
			}
		}
	}
