...
class article extends DbTable
{
	...
	public function __construct()
	{
		...
		// created_by
		$this->created_by = new DbField('article', 'article', 'x_created_by', 'created_by', '`created_by`', '`created_by`', 3, -1, FALSE, '`created_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
