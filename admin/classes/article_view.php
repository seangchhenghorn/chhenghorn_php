...
// Page class
//
class article_view extends article
{
	...
	// Page object name
	public $PageObjName = "article_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if (Get("category_id") !== NULL) {
				...
				$this->category_id->setFormValue(Route(3));
				$this->RecKey["category_id"] = $this->category_id->FormValue;
			} else {
				$returnUrl = "articlelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "articlelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "articlelist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
