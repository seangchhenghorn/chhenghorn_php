...
// Page class
//
class students_delete extends students
{
	...
	// Page object name
	public $PageObjName = "students_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("studentslist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("studentslist.php"); // Return to list
			}
		}
	}
