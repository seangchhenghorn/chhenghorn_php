...
// Page class
//
class category_delete extends category
{
	...
	// Page object name
	public $PageObjName = "category_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("categorylist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("categorylist.php"); // Return to list
			}
		}
	}
