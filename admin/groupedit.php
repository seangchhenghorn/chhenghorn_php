...
<?php if ($group->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_group_id" class="<?php echo $group_edit->LeftColumnClass ?>"><?php echo $group->id->caption() ?><?php echo ($group->id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
