...
define(PROJECT_NAMESPACE . "PROJECT_ID", "{630ABB70-6252-440B-92AA-E90933EF0649}"); // Project ID (GUID)
define(PROJECT_NAMESPACE . "RANDOM_KEY", '1Sd3C7gUo1Q7dCr4'); // Random key for encryption
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "db_crud", "qs" => "`", "qe" => "`");
